              ...
              <div className=" rounded-box border border-base-content/5 bg-base-100 shadow-xl">
                ...
                <div className="p-4 space-y-2">
                  ...
                  <div className="flex gap-5 items-center text-sm">
                    ...
                    <span className="text-right">{donnerDetails.hospitalName}</span>
                  </div>
                  <div className="flex gap-5 items-center text-sm">
              ...
              <fieldset className="fieldset">
                <div className="grid grid-cols-2 gap-5 w-full">
                  <div>
                    {/* Requester name */}
                    <fieldset>
                      <legend className="fieldset-legend">Requster Name</legend>
                      <input
                        type="text"
                    ...
                    <fieldset className="fieldset">
                      ...
                      <select {...register("Blood")} className="select w-full">
